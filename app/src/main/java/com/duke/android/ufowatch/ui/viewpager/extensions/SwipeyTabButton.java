...
package com.duke.android.ufowatch.ui.viewpager.extensions;
...
public class SwipeyTabButton extends Button implements SwipeyTab {
	...
	private static final String TAG = "SwipeyTabButton";
	...
	public SwipeyTabButton(Context context, AttributeSet attrs, int defStyle) {
		...
		mLineHeightSelected = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, mLineHeightSelected, context
